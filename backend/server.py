...
async def chat_proxy(request: Request):
    ...
    # Prepend system message for OpenRouter (uses OpenAI-style format)
    all_messages = [{"role": "system", "content": system}] + merged
    ...
    # Convert OpenRouter response (OpenAI format) to Anthropic format for the frontend
    data = response.json()
